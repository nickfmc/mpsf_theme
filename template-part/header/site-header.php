 ...
 * Tertiary navigation is intentionally omitted here.
 */
?>
...
<header id="c-page-header" class="o-section c-page-header" role="banner" itemscope itemtype="https://schema.org/WPHeader">
	<div class="o-wrapper-wide u-relative">
		...
		<?php /* Sibling of .c-header-actions — that group is desktop-only (display:none on
		mobile), so the mobile-nav trigger/modal must live outside it to stay visible. */ ?>
