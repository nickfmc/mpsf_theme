...
/***/ "./src/js/modules/accessibility-enhancer.js"
/*!**************************************************!*\
  !*** ./src/js/modules/accessibility-enhancer.js ***!
  \**************************************************/
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ AccessibilityWidget)
/* harmony export */ });
/**
 * AccessibilityWidget
 *
...
class AccessibilityWidget {
  constructor() {
    ...
    this.options = [{
      ...
      id: 'a11y-larger-text',
      cls: 'a11y-larger-text'
    }, {
      id: 'a11y-reduced-motion',
      cls: 'a11y-reduced-motion'
    }, {
      id: 'a11y-focus-visible',
      cls: 'a11y-focus-visible'
    }];
  ...
  _bindEvents() {
    ...
    document.addEventListener('click', e => {
      if (this.popup.classList.contains('is-active') && !this.popup.contains(e.target) && !this.widget.contains(e.target)) {
        this._close();
      }
    });
...
/***/ "./src/js/modules/accordion-section.js"
/*!*********************************************!*\
  !*** ./src/js/modules/accordion-section.js ***!
  \*********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initAccordionSections: () => (/* binding */ initAccordionSections)
/* harmony export */ });
/**
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initDropdownMenu: () => (/* binding */ initDropdownMenu)
/* harmony export */ });
/**
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initImpactSliders: () => (/* binding */ initImpactSliders)
/* harmony export */ });
  ...
  menuItems.forEach(menuItem => {
    ...
    link.addEventListener('click', e => {
      ...
      menuItems.forEach(other => {
        if (other !== menuItem && !menuItem.contains(other) && !other.contains(menuItem)) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initModalNav: () => (/* binding */ initModalNav)
/* harmony export */ });
/* harmony import */ var _utils_focus_trap_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/focus-trap.js */ "./src/js/utils/focus-trap.js");
...
function initModalNav() {
  ...
  function open() {
    ...
    releaseTrap = (0,_utils_focus_trap_js__WEBPACK_IMPORTED_MODULE_0__.trapFocus)(navWrap);
  }
  function close() {
  ...
  document.addEventListener('click', e => {
    if (html.classList.contains('has-modal-nav-open') && !e.target.closest('#open-modal-nav') && !e.target.closest('.c-modal-nav-wrap')) {
      close();
    }
  });
}
...
/***/ "./src/js/modules/search-popup.js"
/*!****************************************!*\
  !*** ./src/js/modules/search-popup.js ***!
  \****************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initSearchPopup: () => (/* binding */ initSearchPopup)
/* harmony export */ });
/* harmony import */ var _utils_focus_trap_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/focus-trap.js */ "./src/js/utils/focus-trap.js");
...
function initSearchPopup() {
  ...
  function openPopup() {
    ...
    searchField.focus();
    releaseTrap = (0,_utils_focus_trap_js__WEBPACK_IMPORTED_MODULE_0__.trapFocus)(searchPopup);
  }
  function closePopup() {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_accessibility_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/accessibility.js */ "./src/js/modules/accessibility.js");
/* harmony import */ var _modules_accessibility_enhancer_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/accessibility-enhancer.js */ "./src/js/modules/accessibility-enhancer.js");
/* harmony import */ var _modules_modal_nav_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/modal-nav.js */ "./src/js/modules/modal-nav.js");
...
/* harmony import */ var _modules_accordion_section_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/accordion-section.js */ "./src/js/modules/accordion-section.js");
/**
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (document.getElementById('a11y-widget')) {
    new _modules_accessibility_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
  }

  // Auto-label external / new-tab / PDF links
  const enhancer = new _modules_accessibility_enhancer_js__WEBPACK_IMPORTED_MODULE_1__.AccessibilityEnhancer();
  enhancer.enhanceLinks();
  enhancer.observe();

  // Navigation
  (0,_modules_modal_nav_js__WEBPACK_IMPORTED_MODULE_2__.initModalNav)();
  (0,_modules_mobile_menu_js__WEBPACK_IMPORTED_MODULE_3__.initMobileMenu)();
  ...
  (0,_modules_accordion_section_js__WEBPACK_IMPORTED_MODULE_8__.initAccordionSections)();
});

/***/ },

/***/ "./src/js/utils/focus-trap.js"
/*!************************************!*\
  !*** ./src/js/utils/focus-trap.js ***!
  \************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/**
 * Site entry point.
 * Webpack extracts the imported SCSS to build/site.css.
 */
