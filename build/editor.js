...
[{
  ...
  name: 'eyebrow',
  label: 'Eyebrow Style'
}].forEach(style => (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockStyle)('generateblocks/text', style));
_wordpress_dom_ready__WEBPACK_IMPORTED_MODULE_1___default()(() => {
  ...
  (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.unregisterBlockStyle)('core/button', 'squared');
  ...
  const blocksToRemove = ['core/preformatted', 'core/verse', 'core/pullquote', 'core/media-text', 'core/more', 'core/calendar', 'core/latest-comments', 'core/tag-cloud', 'core/rss', 'core/latest-posts', 'core/categories', 'core/archives'];
  blocksToRemove.forEach(blockName => {
    if ((0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.getBlockType)(blockName)) {
